class Fila:
    ...
    def inserir(self, n):
        self.fila.append(n)
        print("Inserir elemento:", n)

    # 2.4. Crie uma função para retirar o último elemento na “fila”
    def excluir(self):
        if not self.vazia():
    ...
    # 2.6. Crie uma função para testar se um determinado valor, passado por parâmetro, está na “fila”
    ...
    # 2.7. Crie uma função para ordenar uma fila por ordem crescente ou decrescente (tipo de ordenação passado por parâmetro)
